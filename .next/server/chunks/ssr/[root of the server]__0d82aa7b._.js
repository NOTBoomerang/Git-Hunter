 ...
 */ __turbopack_context__.s({
    "generateSetupInstructions": (()=>generateSetupInstructions),
    "getEnvironmentConfig": (()=>getEnvironmentConfig),
    "validateEnvironment": (()=>validateEnvironment),
    "validateEnvironmentOnStartup": (()=>validateEnvironmentOnStartup)
});
...
function generateSetupInstructions(validationResult) {
    const instructions = [];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2d$validation$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/env-validation.ts [app-rsc] (ecmascript)");
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2d$validation$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["validateEnvironmentOnStartup"])();
;
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ fetchRepoFiles(owner, repo, branch = "master") {
    if ("TURBOPACK compile-time falsy", 0) {
        "TURBOPACK unreachable";
    }
    ...
    let branchResp;
    try {
        branchResp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`${GITHUB_API}/repos/${owner}/${repo}/branches/${branch}`, {
            headers: {
    ...
    let treeResp;
    try {
        treeResp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`${GITHUB_API}/repos/${owner}/${repo}/git/trees/${commitSha}?recursive=1`, {
            headers: {
                Authorization: `token ${GITHUB_TOKEN}`,
                Accept: "application/vnd.github.v3+json"
            },
...
/* ----------------------------
   ...
   ---------------------------- */ async function fallbackPatternAnalysis(snippet) {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ debugEnvironment() {
    return {
        ...
        githubTokenPreview: ("TURBOPACK compile-time truthy", 1) ? `${GITHUB_TOKEN.substring(0, 10)}...` : ("TURBOPACK unreachable", undefined),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0d82aa7b._.js.map